...
using luaitech.softwarevendor.plugin.App;
using System;
...
namespace luaitech.softwarevendor.plugin
{
    public class LuaiTechSoftwareVendorPlugin : ISoftwareVendor
    {
        //Log4Net
        private static log4net.ILog _log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public string Name { get => "LuaiTechSoftwareVendorPlugin"; }

        public Type BaseType { get => typeof(IPlugin); }

        public Type Interface { get => typeof(ISoftwareVendor); }

        public LuaiTechSoftwareVendorPlugin()
        {
        }
